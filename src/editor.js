...
(async () => {
  ...
  myId = profile.id; window.myId = myId; window.myId = myId; window.myId = myId;
  myName = profile.username; window.myName = myName; window.myName = myName; window.myName = myName;
...
quill.getModule('toolbar').addHandler('image', function() {
 ...
 // expose for undo/redo toolbar buttons
  ...
  // ── Initialize Yjs ────────────────────────────────────────────────
  window.ydoc = window.ydoc = window.ydoc = ydoc = new Y.Doc();
